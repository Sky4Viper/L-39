...
var path0 = "Aircraft/L-39/gui/dialogs/kneepad/L-39ZA-Kneepad-0.png";
var path1 = "Aircraft/L-39/gui/dialogs/kneepad/L-39ZA-Kneepad-1.png";
...
var pathP = "Aircraft/L-39/gui/dialogs/kneepad/L-39ZA-Kneepad-P.png";
...
var pylons_update = func{
	Lbl_pyln1.setText("P1,4: "~getprop("sim/weight/selected"));
	Lbl_pyln2.setText("P2,3: "~getprop("sim/weight[1]/selected"));
...
var Load_UB162 = func() {
  ...
  var Load_FAB2502 = func() {
        if (OnGround)
        {
		print("P2-3: FAB-250 bombs");
...
pylons_hbox.addSpacing(445);
pylons_hbox.addItem(Lbl_pyln1);
pylons_hbox.addSpacing(55);
...
var button_none = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("none").listen("clicked", func Load_NONE());
...
var button_FT = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("Drop Tank").listen("clicked", func Load_FT());

var button_none2 = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("none").listen("clicked", func Load_NONE2());
var button_R602 = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("R-60M").listen("clicked", func Load_R602());
var button_S52 = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("UB-16").listen("clicked", func Load_UB162());
var button_PK32 = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("PK-3").listen("clicked", func Load_PK32());
var button_FAB2502 = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("FAB-250").listen("clicked", func Load_FAB2502());
var button_FT2 = canvas.gui.widgets.Button.new(payload_root, canvas.style, {}).setText("Drop Tank").listen("clicked", func Load_FT2());
...
button_none2.setSizeHint([84, 25]);
button_R602.setSizeHint([84, 25]);
button_S52.setSizeHint([84, 25]);
button_PK32.setSizeHint([84, 25]);
button_FAB2502.setSizeHint([84, 25]);
button_FT2.setSizeHint([84, 25]);
...
var payload_button_box2 = canvas.VBoxLayout.new();
payload_button_box2.addStretch(1);
payload_button_box2.addItem(button_none2);
payload_button_box2.addItem(button_R602);
payload_button_box2.addItem(button_S52);
payload_button_box2.addItem(button_PK32);
payload_button_box2.addItem(button_FAB2502);
payload_button_box2.addItem(button_FT2);
payload_button_box2.addSpacing(20);

payload_hbox.addSpacing(285);
payload_hbox.addItem(payload_button_box2);
payload_hbox.addSpacing(145);
