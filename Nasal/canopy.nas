...
var cnpy = aircraft.door.new("canopy", 2);
var switch = props.globals.getNode("sim/model/L-39ZA/controls/canopy/canopy-switch", 1);
...
var cockpit_state = func {
	var switch = getprop("sim/model/L-39ZA/controls/canopy/canopy-switch");
	if ( switch == 1 ) {
