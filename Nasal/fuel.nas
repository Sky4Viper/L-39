...
var fuelTanks = func {
	...
	var levelDropStbd2 = getprop("consumables/fuel/tank[5]/level-gal_us");
		if(levelDropStbd2 == nil) { levelDropStbd2 = 0; }
	var levelDropPort2 = getprop("consumables/fuel/tank[4]/level-gal_us");
	...
	var levelWingPort = getprop("consumables/fuel/tank[1]/level-gal_us");
	...
	var wingdroptanks = getprop("sim/weight[0]/weight-lb") + getprop("sim/weight[1]/weight-lb") + getprop("sim/weight[2]/weight-lb") + getprop("sim/weight[3]/weight-lb");
	...
	} elsif (levelIntCentr0 > 0 and fuelPump0 ==1 and fuelPump1 !=1) {
    ...
    } elsif (fuelPump0 !=1 and fuelPump1 !=1) {
