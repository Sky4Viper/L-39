...
props.globals.initNode("/controls/armament/guns-load[1]", 0, "BOOL");
props.globals.initNode("/controls/armament/guns-load[2]", 0, "BOOL");
...
props.globals.initNode("/controls/armament/PK3Left14", 1500, "INT");
props.globals.initNode("/controls/armament/PK3Count14", 1500, "DOUBLE");
props.globals.initNode("/controls/armament/PK3Left23", 1500, "INT");
props.globals.initNode("/controls/armament/PK3Count23", 1500, "DOUBLE");
...
var reload = func {
	if( getprop("/gear/gear[0]/wow") and getprop("/gear/gear[1]/wow") and getprop("/gear/gear[2]/wow") and (getprop("/velocities/groundspeed-kt") < 2) ) {
		...
		setprop("/controls/armament/PK3Left14", 1500);
		setprop("/controls/armament/PK3Count14", 1500);
		setprop("/controls/armament/PK3Left23", 1500);
		setprop("/controls/armament/PK3Count23", 1500);
...
var outOfAmmo = maketimer(1.0, 
	func { 
		...
		setprop("/controls/armament/PK3Left14", 0);
		setprop("/controls/armament/PK3Count14", 0);
		setprop("/controls/armament/PK3Left23", 0);
		setprop("/controls/armament/PK3Count23", 0);
	}
);
...
var triggerControl = func {
	...
	PK3_1_Charged = getprop("/controls/armament/guns-load[1]");
	PK3_2_Charged = getprop("/controls/armament/guns-load[2]");
	if(triggerState and MasterArm and getprop("/controls/armament/PK3Left") > 0) {
		...
		Pylons14_ON = (getprop("controls/armament/pylon-outer-sel") == 1);
		Pylons23_ON = (getprop("controls/armament/pylon-inner-sel") == 1);
		
		if(PK3mounted1L or PK3mounted2L) {
			var fireTime = 2.05714; #continuous fire for 3500 r/min
			if(PK3mounted1L and PK3OuterON and Pylons14_ON and PK3_1_Charged) {
				setprop("/controls/armament/trigger-PK3-out", 1);
			}
			if(PK3mounted2L and PK3InnerON and Pylons23_ON and PK3_2_Charged) {
		...
		setprop("/controls/armament/PK3Left", getprop("/controls/armament/PK3Count"));#gets truncated
		interpolate("/controls/armament/PK3Count", getprop("/controls/armament/PK3Left"), 0);
		outOfAmmo.stop();
